...
return [
    ...
    */
    ...
    'gte' => [
        ...
        'string' => 'O: attribute deve ser maior ou igual aos caracteres de valor.',
    ...
    'lte' => [
        ...
        'string' => 'O: attribute deve ser menor ou igual aos caracteres de valor.',
    ...
    'required_if' => 'O formato: attribute é inválido.',
    'required_unless' => 'O campo: attribute é obrigatório quando: other for: value.',
    'required_with' => 'O campo: attribute é obrigatório, a menos que: other esteja em: values.',
    'required_with_all' => 'O campo: attribute é obrigatório quando: values estiver presente.',
    'required_without' => 'O campo: attribute é obrigatório quando: valores estão presentes.',
    'required_without_all' => 'O campo: attribute é obrigatório quando: values não estiver presente.',
    'same' => 'O: attribute e: other devem corresponder.',
    'size' => [
        'numeric' => 'O: attribute e: other devem corresponder.',
